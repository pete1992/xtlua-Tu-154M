...
INT_ARG(key)
CALL_FUNCTION(IsKeyDown, bool, static_cast<ImGuiKey>(key))
PUSH_BOOL(ret)
END_IMGUI_FUNC
...
CALL_FUNCTION(IsKeyPressed, bool, static_cast<ImGuiKey>(key), repeat)
PUSH_BOOL(ret)
END_IMGUI_FUNC
//    IMGUI_API bool          IsKeyReleased(ImGuiKey key);                                        // was key released (went from Down to !Down)?
IMGUI_FUNCTION(IsKeyReleased)
INT_ARG(key)
CALL_FUNCTION(IsKeyReleased, bool, static_cast<ImGuiKey>(key))
PUSH_BOOL(ret)
END_IMGUI_FUNC
...
INT_ARG(key)
CALL_FUNCTION(GetKeyName, const char*, static_cast<ImGuiKey>(key))
PUSH_STRING(ret)
END_IMGUI_FUNC
...
INT_ARG(key)
CALL_FUNCTION_NO_RET(SetItemKeyOwner, static_cast<ImGuiKey>(key))
END_IMGUI_FUNC
...
MAKE_ENUM(ImGuiTreeNodeFlags_NavLeftJumpsToParent,NavLeftJumpsBackHere)
...
MAKE_ENUM(ImGuiTabBarFlags_FittingPolicyShrink,FittingPolicyResizeDown)
...
MAKE_ENUM((1 << 2),NavEnableSetMousePos) // Legacy Lua constant; use io.ConfigNavMoveSetMousePos in current ImGui
//    ImGuiConfigFlags_NavNoCaptureKeyboard   = 1 << 3,   // [moved/renamed in 1.91.4] -> use bool io.ConfigNavCaptureKeyboard
MAKE_ENUM((1 << 3),NavNoCaptureKeyboard) // Legacy Lua constant; use io.ConfigNavCaptureKeyboard in current ImGui
...
MAKE_ENUM(ImGuiColorEditFlags_None,AlphaPreview)
...
MAKE_ENUM(ImGuiMultiSelectFlags_SelectOnAuto,SelectOnClick)
